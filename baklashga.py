...
async def process_pre_checkout(pre_checkout_query: PreCheckoutQuery):
    # Stars faqat emoji/gift kabi bevosita Telegram Stars to'lovlari uchun ishlatiladi.
    # Stars orqali foydalanuvchi balansini to'ldirish o'chirilgan.
...
async def main():
    ...
    # Railway polling rejimida ishlaydi. Oldingi webhook qolib ketgan bo\u2018lsa,
    # Telegram getUpdates bilan webhookni bir vaqtda ishlatishga ruxsat bermaydi.
